...
enum {
    ...
    // Tiski
    NATIONAL_DEX_BOBBUG,
    NATIONAL_DEX_CHRYSTITCH,
    NATIONAL_DEX_EMBROIDLE,
    NATIONAL_DEX_DIRBUNY,
    NATIONAL_DEX_DEILINT,
    NATIONAL_DEX_EYRSTLING,
    NATIONAL_DEX_SKEYRIE,
    NATIONAL_DEX_HUNTALON,
    NATIONAL_DEX_TADDLE,
    NATIONAL_DEX_TUTARAIN,
    NATIONAL_DEX_TUATIDE,
    NATIONAL_DEX_GOOZE,
    NATIONAL_DEX_SYROOP,
    NATIONAL_DEX_CRIAQUA,
    NATIONAL_DEX_ALPAQUA,
    NATIONAL_DEX_BHUNSEN,
    NATIONAL_DEX_BHURNUR,
    NATIONAL_DEX_IRRITAUNT,
    NATIONAL_DEX_POMPARADE,
    NATIONAL_DEX_ERGOMOUSE,
    NATIONAL_DEX_KIINY,
    NATIONAL_DEX_CAPRANE,
    NATIONAL_DEX_BARBEX,
    NATIONAL_DEX_TOTEMAG,
    NATIONAL_DEX_BEARBELL,
    NATIONAL_DEX_BEARBUILT,
    NATIONAL_DEX_PSUEBBLE,
    NATIONAL_DEX_REVELOOM,
    NATIONAL_DEX_SPRINCAPE,
    NATIONAL_DEX_SPRINCHEER,
    NATIONAL_DEX_SPRINCHARGE,
    NATIONAL_DEX_MAITTIEL,
    NATIONAL_DEX_CHIFOPTERA,
    NATIONAL_DEX_TEMMIN,
    NATIONAL_DEX_STALLIWART,
    NATIONAL_DEX_INDUSTUSK,
    NATIONAL_DEX_LAPIDEON,
    NATIONAL_DEX_MELODEON,
    NATIONAL_DEX_PORYGONB,
    NATIONAL_DEX_PORYGONQ,
    NATIONAL_DEX_TUMBLAZE,
    NATIONAL_DEX_JURRALO,
    NATIONAL_DEX_POLARALO,
    NATIONAL_DEX_GEODODO,
    NATIONAL_DEX_ROKSTINCT,
    NATIONAL_DEX_GAVISCALE,
    NATIONAL_DEX_WYRUMM,
    NATIONAL_DEX_AMPHIPTUNE,
    NATIONAL_DEX_HARMONICLAW,
    NATIONAL_DEX_NUSEANCE,
    NATIONAL_DEX_DETROTUS,
    NATIONAL_DEX_KANTAREIN,
    NATIONAL_DEX_STARVEQUUS,
    NATIONAL_DEX_MORTALLION,
    NATIONAL_DEX_VALOMARE,
    NATIONAL_DEX_CRONOTURN,
};

#define KANTO_DEX_COUNT     NATIONAL_DEX_MEW
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_T_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT NATIONAL_DEX_CRONOTURN
...
enum {
    ...
    TISKI_DEX_REVELOOM,
    TISKI_DEX_SPRINCAPE,
    TISKI_DEX_SPRINCHEER,
    TISKI_DEX_SPRINCHARGE,
    TISKI_DEX_MAITTIEL,
    TISKI_DEX_CHIFOPTERA,
    TISKI_DEX_TEMMIN,
    TISKI_DEX_STALLIWART,
    TISKI_DEX_INDUSTUSK,
    TISKI_DEX_LAPIDEON,
    TISKI_DEX_MELODEON,
    TISKI_DEX_PORYGONB,
    ...
    TISKI_DEX_GAVISCALE,
    TISKI_DEX_WYRUMM,
    TISKI_DEX_AMPHIPTUNE,
    TISKI_DEX_HARMONICLAW,
    TISKI_DEX_NUSEANCE,
    TISKI_DEX_DETROTUS,
    TISKI_DEX_KANTAREIN,
    TISKI_DEX_STARVEQUUS,
    TISKI_DEX_MORTALLION,
    TISKI_DEX_VALOMARE,
    TISKI_DEX_CRONOTURN,
    TISKI_DEX_WURMPLE,
};

#define TISKI_DEX_COUNT (TISKI_DEX_WURMPLE + 1)
